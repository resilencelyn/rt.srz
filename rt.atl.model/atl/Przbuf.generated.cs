// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Przbuf.cs" company="РусБИТех">
...
namespace rt.atl.model.atl
{
   [DataContract] 
	 [Serializable]
   public partial class Przbuf : BusinessBase<int>
   {
      public Przbuf() { }
      ...
      [XmlElement(Order =  78)]
      [DataMember(Order =  78)]
      public virtual string Oldfam { get; set;}
        
      [XmlElement(Order =  79)]
      [DataMember(Order =  79)]
      public virtual string Oldim { get; set;}
        
      [XmlElement(Order =  80)]
      [DataMember(Order =  80)]
      public virtual string Oldot { get; set;}
        
      [XmlElement(Order =  81)]
      [DataMember(Order =  81)]
      public virtual System.DateTime? Olddr { get; set;}
        
      [XmlElement(Order =  82)]
      [DataMember(Order =  82)]
      public virtual int? Oldw { get; set;}
        
      [XmlElement(Order =  83)]
      [DataMember(Order =  83)]
      public virtual string Oldmr { get; set;}
        
      [XmlElement(Order =  84)]
      [DataMember(Order =  84)]
      public virtual string Olddoctp { get; set;}
        
      [XmlElement(Order =  85)]
      [DataMember(Order =  85)]
      public virtual string Olddocs { get; set;}
        
      [XmlElement(Order =  86)]
      [DataMember(Order =  86)]
      public virtual string Olddocn { get; set;}
        
      [XmlElement(Order =  87)]
      [DataMember(Order =  87)]
      public virtual System.DateTime? Olddocdt { get; set;}
        
      [XmlElement(Order =  88)]
      [DataMember(Order =  88)]
      public virtual string Sflk { get; set;}
        
      [XmlElement(Order =  89)]
      [DataMember(Order =  89)]
      public virtual string Eerp { get; set;}
      ...
      [XmlElement(Order =  93)]
      [DataMember(Order =  93)]
      public virtual int? Opid { get; set;}
      ...
      [XmlElement(Order =  98)]
      [DataMember(Order =  98)]
      public virtual int? Rescode { get; set;}
      ...
      public virtual int? Eins { get; set;}
      ...
      public virtual int? Et { get; set;}
        
      [XmlElement(Order =  112)]
      [DataMember(Order =  112)]
      public virtual int? At { get; set;}
      ...
      public virtual int? Zp1id { get; set;}
        
      [XmlElement(Order =  115)]
      [DataMember(Order =  115)]
      public virtual int? A08id { get; set;}
        
      [XmlElement(Order =  116)]
      [DataMember(Order =  116)]
      public virtual int? Vpdid { get; set;}
      ...
      public virtual string Olddocorg { get; set;}
      ...
      public virtual string Oldss { get; set;}
      ...
      public virtual System.DateTime? Olddocend { get; set;}
        
      [XmlElement(Order =  146)]
      [DataMember(Order =  146)]
      public virtual string Oldrdoctp { get; set;}
        
      [XmlElement(Order =  147)]
      [DataMember(Order =  147)]
      public virtual string Oldrdocs { get; set;}
        
      [XmlElement(Order =  148)]
      [DataMember(Order =  148)]
      public virtual string Oldrdocn { get; set;}
        
      [XmlElement(Order =  149)]
      [DataMember(Order =  149)]
      public virtual System.DateTime? Oldrdocdt { get; set;}
        
      [XmlElement(Order =  150)]
      [DataMember(Order =  150)]
      public virtual string Oldrdocorg { get; set;}
        
      [XmlElement(Order =  151)]
      [DataMember(Order =  151)]
      public virtual System.DateTime? Oldrdocend { get; set;}
        
        
		  [XmlElement(Order =  152)]
      [DataMember(Order =  152)]
		  public virtual Przlog PRZLOG { get; set;}
