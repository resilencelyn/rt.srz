...
namespace rt.core.business.test
{
  ...
  public class GoodStatement
  {
    public static Statement CreateGoodStatement(User currentUser)
    {
      ...
      statement.FormManufacturing = ObjectFactory.GetInstance<IConceptManager>().GetById(PolisType.П);     
      statement.CauseFiling = ObjectFactory.GetInstance<IConceptManager>().GetById(CauseReinsurance.Choice);
