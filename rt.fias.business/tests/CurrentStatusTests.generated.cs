...
{
	[TestFixture]
    public partial class CurrentStatusTests : UnitTestbase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            manager = ObjectFactory.GetInstance<ICurrentStatusManager>();
        ...
        protected rt.fias.business.manager.ICurrentStatusManager manager;
      ...
      entity.Name = "Test Test ";
		...
		protected rt.fias.model.fias.CurrentStatus GetFirstCurrentStatus()
        {
            IList<rt.fias.model.fias.CurrentStatus> entityList = manager.GetAll(1);
