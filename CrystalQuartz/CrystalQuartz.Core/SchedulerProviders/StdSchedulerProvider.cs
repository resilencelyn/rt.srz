    ...
    public class StdSchedulerProvider : ISchedulerProvider
    {
        ...
        private void LazyInit()
        {
            ...
            try
            {
                ...
                ISchedulerFactory schedulerFactory = ObjectFactory.TryGetInstance<ISchedulerFactory>() ?? new StdSchedulerFactory(properties);
            ...
            if (_scheduler == null)
            {
                throw new SchedulerProviderException("Could not initialize scheduler", properties);
            }
        }
