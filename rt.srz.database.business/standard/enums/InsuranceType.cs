// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InsuranceType.cs" company="РусБИТех">
...
namespace rt.srz.database.business.standard.enums
{
  ...
  public enum InsuranceType : byte
  {
    ...
    /// <summary>
    ///   "В" - временное свидетельство (временное свидетельство, подтверждающее оформление полиса обязательного медицинского
    ///   страхования)
    /// </summary>
    Temporary = 5, 
