// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatch.cs" company="РусБИТех">
...
namespace rt.core.business.server.exchange.export
{
  ...
  ///   The export batch.
  /// </summary>
  public abstract class ExporterBatch : IExporterBatch
  {
    #region Constructors and Destructors

    /// <summary>
    /// Initializes a new instance of the <see cref="ExporterBatch"/> class. 
    /// Конструктор
    /// </summary>
    /// <param name="type">
    /// The type.
    /// </param>
    protected ExporterBatch(Guid type)
    {
      TypeBatch = type;
    ...
    ///   Gets the type batch.
    /// </summary>
    public Guid TypeBatch { get; protected set; }
