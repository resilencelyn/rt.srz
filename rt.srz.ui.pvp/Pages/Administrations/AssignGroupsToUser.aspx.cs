...
{
	public partial class AssignGroupsToUser : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				MasterPage.ActionTitle = "";//string.Format("Добавление в группы пользователя: {0}", Request.QueryString["UserName"]);
			}
		}
