...
{
	public partial class AssignUsersToGroup : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				MasterPage.ActionTitle = "";//string.Format("Добавление пользователей в группу: {0}", Request.QueryString["GroupName"]);
			}
		}
		...
		{
			assignUsersToGroupControl.SaveChanges();
      RedirectUtils.RedirectToAdministrationUsers(Response);
		}
