// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BasePersonTemplate.cs" company="Альянс">
...
namespace rt.srz.model.Hl7.person
{
  ...
  public class BasePersonTemplate
  {
    ...
    ///   The adt_ a 03.
    /// </summary>
    [XmlElement(ElementName = "ADT_A03", Order = 4)]
    public List<ADT_A03> Adt_A03;

    /// <summary>
    ///   The adt_ a 24.
    /// </summary>
    [XmlElement(ElementName = "ADT_A24", Order = 5)]
    public List<ADT_A24> Adt_A24;

    /// <summary>
    ///   The adt_ a 37.
    /// </summary>
    [XmlElement(ElementName = "ADT_A37", Order = 6)]
    ...
    ///   The end NsiMoPacket.
    /// </summary>
    [XmlElement(ElementName = "BTS", Order = 30)]
    ...
    ///   The qbp_ zp 1.
    /// </summary>
    [XmlElement(ElementName = "QBP_ZP1", Order = 7)]
    public List<QBP_ZP1> Qbp_Zp1;

    /// <summary>
    ///   The qbp_ zp 2.
    /// </summary>
    [XmlElement(ElementName = "QBP_ZP2", Order = 8)]
    public List<QBP_ZP2> Qbp_Zp2;

    /// <summary>
    ///   The qbp_ zp 4.
    /// </summary>
    [XmlElement(ElementName = "QBP_ZP4", Order = 9)]
    public List<QBP_ZP4> Qbp_Zp4;

    /// <summary>
    ///   The qbp_ zp 6.
    /// </summary>
    [XmlElement(ElementName = "QBP_ZP6", Order = 10)]
    public List<QBP_ZP6> Qbp_Zp6;

    /// <summary>
    ///   The qbp_ zp 9.
    /// </summary>
    [XmlElement(ElementName = "QBP_ZP9", Order = 11)]
    public List<QBP_ZP9> Qbp_Zp9;

    /// <summary>
    ///   The rsp_ zk 1.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK1", Order = 12)]
    public List<RSP_ZK1> Rsp_Zk1;

    /// <summary>
    ///   The rsp_ zk 2.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK2", Order = 13)]
    public List<RSP_ZK2> Rsp_Zk2;

    /// <summary>
    ///   The rsp_ zk 4.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK4", Order = 14)]
    public List<RSP_ZK4> Rsp_Zk4;

    /// <summary>
    ///   The rsp_ zk 5.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK5", Order = 15)]
    public List<RSP_ZK5> Rsp_Zk5;

    /// <summary>
    ///   The rsp_ zk 6.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK6", Order = 16)]
    public List<RSP_ZK6> Rsp_Zk6;

    /// <summary>
    ///   The rsp_ zk 9.
    /// </summary>
    [XmlElement(ElementName = "RSP_ZK9", Order = 17)]
    public List<RSP_ZK9> Rsp_Zk9;

    /// <summary>
    ///   The zpi zwis.
    /// </summary>
    [XmlElement(ElementName = "ZPI_ZWI", Order = 18)]
    public List<ZpiZwi> ZpiZwis;

    /// <summary>
    ///   The zpi_za 1.
    /// </summary>
    [XmlElement(ElementName = "ZPI_ZA1", Order = 19)]
    public List<ZPI_ZA1> Zpi_za1;

    /// <summary>
    ///   The zpi_za 7.
    /// </summary>
    [XmlElement(ElementName = "ZPI_ZA7", Order = 20)]
