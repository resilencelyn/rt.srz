// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HouseInterval.cs" company="РусБИТех">
...
namespace rt.fias.model.fias
{
   [DataContract] 
	 [Serializable]
   public partial class HouseInterval : BusinessBase<System.Guid>
   {
      ...
      [XmlElement(Order =  10)]
      [DataMember(Order =  10)]
      public virtual int Intstart { get; set;}
      ...
      [XmlElement(Order =  12)]
      [DataMember(Order =  12)]
      public virtual System.Guid Intguid { get; set;}
      ...
      public virtual int Counter { get; set;}
		  ...
		  [XmlElement(Order =  18)]
      [DataMember(Order =  18)]
		  public virtual IntervalStatus INTSTATUS { get; set;}
