...
namespace rt.core.business.security.repository
{
  ...
  public class SecurityProvider : ISecurityProvider
  {
    ...
    public User CheckCridentials(string userName, string password)
    {
      ...
      if (user.PointDistributionPolicy.Parent != null && (!user.PointDistributionPolicy.IsActive || !user.PointDistributionPolicy.Parent.IsActive))
      {
      ...
      ////  RemoteEndpointMessageProperty ep = null;
      ////  Uri via = null;
      ////  if (context != null)
      ////  {
      ////    MessageProperties messageProperties = context.IncomingMessageProperties;
      ////    ep = messageProperties[RemoteEndpointMessageProperty.Name] as RemoteEndpointMessageProperty;
      ////    via = messageProperties.Via;
      ////  }

      ////  logger.LogAuth(isAuthenticated, GetType().Name, userName, ep, via);
      ////}
    }
    ...
    public User GetCurrentUser()
    {
      if (HttpContext.Current != null)
      {
        ...
        {
          var userByName = ObjectFactory.GetInstance<ISecurityService>().GetUserByName(HttpContext.Current.User.Identity.Name);
