// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IStatementChangeDateManager.cs" company="јль€нс">
...
namespace rt.srz.business.manager
{
  ...
  public partial interface IStatementChangeDateManager
  {
    ...
    /// <summary>
    /// –еплицирует историю изменени€ приватных данных и данных документа
    /// </summary>
    ...
    /// <summary>
    /// —охран€ет историю изменени€ приватных данных и данных документа
    /// </summary>
