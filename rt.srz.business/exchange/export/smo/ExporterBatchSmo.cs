// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatchSmo.cs" company="РусБИТех">
...
namespace rt.srz.business.exchange.export.smo
{
  ...
  /// тип ноды
  /// </typeparam>
  public abstract class ExporterBatchSmo<TSerializeObject, TNode> : ExporterBatchSrz<TSerializeObject, TNode>
  {
    #region Constructors and Destructors

    /// <summary>
    /// Initializes a new instance of the <see cref="ExporterBatchSmo{TSerializeObject,TNode}"/> class.
    /// </summary>
    /// <param name="type">
    /// The type.
    /// </param>
    ...
    /// The type file id.
    /// </param>
    public ExporterBatchSmo(Guid type, int typeSubjectId, int typeFileId)
