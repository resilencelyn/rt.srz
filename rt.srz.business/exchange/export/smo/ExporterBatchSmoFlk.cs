// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatchSmoFlk.cs" company="РусБИТех">
...
namespace rt.srz.business.exchange.export.smo
{
  ...
  ///   The export batch smo flk.
  /// </summary>
  public class ExporterBatchSmoFlk : ExporterBatchSmo<PFLKType, PRType>
  {
    #region Constructors and Destructors

    /// <summary>
    ///   Initializes a new instance of the <see cref="ExporterBatchSmoFlk" /> class.
    /// </summary>
    public ExporterBatchSmoFlk()
      : base(Exporters.SmoFlkExporter, ExchangeSubjectType.Tfoms, ExchangeFileType.Flk)
    {
    }
    ...
    public override void BeginBatch()
    {
      ...
      Batch.Type = conceptManager.GetById(ExchangeFileType.Flk);
