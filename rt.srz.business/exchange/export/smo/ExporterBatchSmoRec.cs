// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatchSmoRec.cs" company="РусБИТех">
...
namespace rt.srz.business.exchange.export.smo
{
  ...
  ///   The export batch pfr.
  /// </summary>
  public class ExporterBatchSmoRec : ExporterBatchSmo<RECListType, RECType>
  {
    #region Constructors and Destructors

    /// <summary>
    ///   Initializes a new instance of the <see cref="ExporterBatchSmoRec" /> class.
    /// </summary>
    public ExporterBatchSmoRec()
      : base(Exporters.SmoRecExporter, ExchangeSubjectType.Smo, ExchangeFileType.Rec)
    {
    }
