// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatchSmoRep.cs" company="РусБИТех">
...
namespace rt.srz.business.exchange.export.smo
{
  ...
  ///   The export batch smo rep.
  /// </summary>
  public class ExporterBatchSmoRep : ExporterBatchSmo<REPListType, REPType>
  {
    #region Constructors and Destructors

    /// <summary>
    ///   Initializes a new instance of the <see cref="ExporterBatchSmoRep" /> class.
    /// </summary>
    public ExporterBatchSmoRep()
      : base(Exporters.SmoRepExporter, ExchangeSubjectType.Tfoms, ExchangeFileType.Rep)
    {
    }
    ...
    public override void BeginBatch()
    {
      ...
      Batch.Type = conceptManager.GetById(ExchangeFileType.Rep);
