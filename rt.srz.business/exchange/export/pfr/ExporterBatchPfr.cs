// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExporterBatchPfr.cs" company="РусБИТех">
...
namespace rt.srz.business.exchange.export.pfr
{
  ...
  ///   The export batch pfr.
  /// </summary>
  public class ExporterBatchPfr : ExporterBatchTyped<SnilsZlListAtr, string>
  {
    #region Constructors and Destructors

    /// <summary>
    ///   Initializes a new instance of the <see cref="ExporterBatchPfr" /> class.
    /// </summary>
    public ExporterBatchPfr()
      : base(Exporters.PfrExporter)
    {
    }
