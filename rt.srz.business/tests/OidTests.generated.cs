...
{
	[TestFixture]
    public partial class OidTests : UnitTestbase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            manager = ObjectFactory.GetInstance<IOidManager>();
		...
		protected rt.srz.model.srz.Oid GetFirstOid()
        {
            IList<rt.srz.model.srz.Oid> entityList = manager.GetAll(1);
		...
		public void Update()
        {
            try
            {
                ...
                rt.srz.model.srz.Oid entityA = GetFirstOid();
				
				entityA.FullName = "Test Test ";
				
				manager.Update(entityA);

                rt.srz.model.srz.Oid entityB = manager.GetById(entityA.Id);

                Assert.AreEqual(entityA.FullName, entityB.FullName);
            }
            catch (Exception ex)
            {
                Assert.Fail(ex.ToString());
        ...
        public void Delete()
        {
            try
            {
                ...
                rt.srz.model.srz.Oid entity = GetFirstOid();
