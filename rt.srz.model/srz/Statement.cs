...
namespace rt.srz.model.srz
{
  ...
  public partial class Statement
  {
    ...
    public virtual string NumberTemporaryCertificate
    {
      get
      {
        var insurance = MedicalInsurances != null ? MedicalInsurances.FirstOrDefault(x => x.PolisType.Id == PolisType.Â) : null;
        if (insurance != null)
        {
    ...
    public virtual string NumberPolisCertificate
    {
      get
      {
        var insurance = MedicalInsurances != null ? MedicalInsurances.FirstOrDefault(x => x.PolisType.Id != PolisType.Â && x.IsActive) : null;
        if (insurance != null)
        {
          return insurance.PolisNumber;
        }
    ...
    public virtual MedicalInsurance TempMedicalInsurance
    {
      get
      {
        return MedicalInsurances != null ? MedicalInsurances.FirstOrDefault(x => x.PolisType.Id == PolisType.Â && x.IsActive) : null;
      }
    }
